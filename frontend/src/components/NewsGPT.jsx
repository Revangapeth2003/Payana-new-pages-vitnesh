      ...
      <div className="news-right">
        ...
        <ul className="features-list">
            <li className="list-item">
               ...
               <span>Licensed consultant</span>
            </li>
            <li className="list-item">
               <FaCheckCircle className="icon" />
               <span>Direct counseling with experts</span>
            </li>
          <li className="list-item">
               <FaCheckCircle className="icon" />
               <span>Work while you study</span>
          </li>
          ...
          <li className="list-item">
               <FaCheckCircle className="icon" />
               <span>Certified trainers (IELTS, TOEFL,PTE)</span>
          </li>
          <li className="list-item">
               <FaCheckCircle className="icon" />
               <span>Foreign language trainings</span>
          </li>
        </ul>
            </div>
