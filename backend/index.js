...
import stipendRouter from './routes/stipendRoute.js';
import artsRouter from './routes/artsRoute.js'; // ✅ Added arts router import
...
app.use('/api', stipendRouter);      // Prefix stipend routes with /api
app.use('/api', artsRouter);         // ✅ Added arts routes with /api prefix
...
app.get('/health', (req, res) => {
  res.json({ 
    ...
    routes: {
      ...
      visa: '/api/visa/*',
      stipend: '/api/stipend/*',
      arts: '/api/arts-tech-application', // ✅ Added arts route
...
app.get('/', (_req, res) => {
  res.json({ 
    ...
    features: {
      ...
      forms: 'Study/Work/Investment/Stipend/Arts-Tech form handling' // ✅ Updated to include arts-tech
    },
    endpoints: {
      chatbot: {
      ...
      forms: {
        ...
        stipend: 'POST /api/submit-stipend-form',
        artsTech: 'POST /api/arts-tech-application', // ✅ Added arts-tech form endpoint
        email: 'POST /api/send-email'
      },
      stipend: {
        submit: 'POST /api/submit-stipend-form',
        getAll: 'GET /api/stipend-applications',
        getById: 'GET /api/stipend-applications/:id'
      },
      artsTech: { // ✅ Added arts-tech section
        submit: 'POST /api/arts-tech-application'
      },
      health: 'GET /health'
    },
    chatbotFlow: {
...
app.use('*', (req, res) => {
  res.status(404).json({ 
    ...
    availableEndpoints: [
      ...
      'POST /api/submit-stipend-form',
      'POST /api/arts-tech-application', // ✅ Added arts-tech form
      'GET /api/stipend-applications',
      'GET /api/stipend-applications/:id',
      'POST /api/send-email'
    ]
  });
});
...
server.listen(PORT, () => {
  ...
  console.log(`🎓 Stipend API: http://localhost:${PORT}/api/submit-stipend-form`);
  console.log(`🎨 Arts-Tech API: http://localhost:${PORT}/api/arts-tech-application`); // ✅ Added arts-tech endpoint log
  ...
  console.log(`🏠 Tables: study, work_profiles, invest, chatbot_users, chatbot_messages, stipend_applications, arts_tech_applications`); // ✅ Added arts_tech table
